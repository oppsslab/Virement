sap.ui.define(
  ...
  function (MessageBox, MessageToast, Fragment, ResourceModel) {
     ...
     * the FunctionalDepartmentGrouping entity/fields.
     */
    ...
    function triggerDownload(sBase64, sFileName, sMimeType) {
      ...
      oLink.href = sUrl;
      oLink.download = sFileName || "Functional Department Grouping Template.xlsx";
    ...
    function handleConfirmUpload() {
      ...
      const oOperation = oUploadModel.bindContext("/uploadFunctionalDepartmentGrouping(...)");
      ...
      oOperation
        ...
        .then(function () {
          ...
          /*
           * FunctionalDepartmentGrouping is draft-enabled (required for the List
        ...
        .then(function () {
          ...
          MessageToast.show("Functional Department Grouping rows uploaded successfully.");
        })
    ...
    function clearSelectedUploadFile() {
      ...
      const oFileUploader = byFragId(
        oUploadDialog,
        "functionalDepartmentGroupingFileUploader",
        oUploadView,
      );
    ...
    return {
      onDownloadTemplate: function (oEvent) {
        ...
        const oOperation = oModel.bindContext(
          "/downloadFunctionalDepartmentGroupingTemplate(...)",
        );
      ...
      onOpenUploadDialog: function (oEvent) {
        ...
        if (!oUploadDialog) {
          Fragment.load({
            id: oView ? oView.getId() : "functionalDepartmentGroupingUploadFrag",
            name: "virement.zuippsvirement.ext.fragment.FunctionalDepartmentGroupingUploadDialog",
            controller: this,
          })
