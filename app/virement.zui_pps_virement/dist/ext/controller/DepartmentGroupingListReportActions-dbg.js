sap.ui.define(
  ...
  function (MessageBox, MessageToast, Fragment, ResourceModel) {
     ...
     * the DepartmentGrouping entity/fields.
     */
    ...
    function triggerDownload(sBase64, sFileName, sMimeType) {
      ...
      oLink.href = sUrl;
      oLink.download = sFileName || "Department Grouping Template.xlsx";
    ...
    function handleConfirmUpload() {
      ...
      const oOperation = oUploadModel.bindContext("/uploadDepartmentGrouping(...)");
      ...
      oOperation
        ...
        .then(function () {
          ...
          /*
           * DepartmentGrouping is draft-enabled (required for the List
        ...
        .then(function () {
          ...
          MessageToast.show("Department Grouping rows uploaded successfully.");
        })
    ...
    function clearSelectedUploadFile() {
      ...
      const oFileUploader = byFragId(
        oUploadDialog,
        "departmentGroupingFileUploader",
        oUploadView,
      );
    ...
    return {
      onDownloadTemplate: function (oEvent) {
        ...
        const oOperation = oModel.bindContext(
          "/downloadDepartmentGroupingTemplate(...)",
        );
      ...
      onOpenUploadDialog: function (oEvent) {
        ...
        if (!oUploadDialog) {
          Fragment.load({
            id: oView ? oView.getId() : "departmentGroupingUploadFrag",
            name: "virement.zuippsvirement.ext.fragment.DepartmentGroupingUploadDialog",
            controller: this,
          })
