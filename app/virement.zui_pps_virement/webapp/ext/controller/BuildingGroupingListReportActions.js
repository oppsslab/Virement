sap.ui.define(
  ...
  function (MessageBox, MessageToast, Fragment, ResourceModel) {
     ...
     * the BuildingGrouping entity/fields.
     */
    ...
    function triggerDownload(sBase64, sFileName, sMimeType) {
      ...
      oLink.href = sUrl;
      oLink.download = sFileName || "Building Grouping Template.xlsx";
    ...
    function handleConfirmUpload() {
      ...
      const oOperation = oUploadModel.bindContext("/uploadBuildingGrouping(...)");
      ...
      oOperation
        ...
        .then(function () {
          ...
          /*
           * BuildingGrouping is draft-enabled (required for the List
        ...
        .then(function () {
          ...
          MessageToast.show("Building Grouping rows uploaded successfully.");
        })
    ...
    return {
      onDownloadTemplate: function (oEvent) {
        ...
        const oOperation = oModel.bindContext(
          "/downloadBuildingGroupingTemplate(...)",
        );
      ...
      onOpenUploadDialog: function (oEvent) {
        ...
        if (!oUploadDialog) {
          Fragment.load({
            id: oView ? oView.getId() : "buildingGroupingUploadFrag",
            name: "virement.zuippsvirement.ext.fragment.BuildingGroupingUploadDialog",
            controller: this,
          })
