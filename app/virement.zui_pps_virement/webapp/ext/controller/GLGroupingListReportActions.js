sap.ui.define(
  ...
  function (MessageBox, MessageToast, Fragment, ResourceModel) {
    ...
    function triggerDownload(sBase64, sFileName, sMimeType) {
      ...
      oLink.href = sUrl;
      oLink.download = sFileName || "GL Grouping Template.xlsx";
    ...
    function handleConfirmUpload() {
      ...
      const oOperation = oUploadModel.bindContext("/uploadGLGrouping(...)");
      ...
      oOperation
        ...
        .then(function () {
          ...
          /*
           * GLGrouping is draft-enabled (required for the List
          ...
          const aCreatedContexts = aRows.map(function (oRow) {
            return oListBinding.create({
              expenditureGroup: oRow.expenditureGroup,
              glGroup: oRow.glGroup,
              glAccount: oRow.glAccount,
              glAccountDescription: oRow.glAccountDescription,
              assetType: oRow.assetType,
              functional: oRow.functional,
            });
          });
        ...
        .then(function () {
          ...
          MessageToast.show("GL Grouping rows uploaded successfully.");
        })
    ...
    return {
      ...
      onOpenUploadDialog: function (oEvent) {
        ...
        if (!oUploadDialog) {
          Fragment.load({
            id: oView ? oView.getId() : "glGroupingUploadFrag",
            name: "virement.zuippsvirement.ext.fragment.GLGroupingUploadDialog",
            controller: this,
          })
