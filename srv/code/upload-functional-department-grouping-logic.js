...
const LOG = cds.log("upload-functional-department-grouping-logic");
...
function validateRow(row) {
  ...
  if (!functionalDepartment) {
    errors.push({
      ...
      message: `Row ${rowNo}: Functional Department is required.`,
    });
  }
...
module.exports = async function uploadFunctionalDepartmentGrouping(request) {
  LOG.info("--- uploadFunctionalDepartmentGrouping started ---");
  ...
  try {
    ...
    LOG.error("uploadFunctionalDepartmentGrouping failed unexpectedly:", error);
